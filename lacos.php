...
<link rel="stylesheet" href="lacos.css">
...
<div class="box1">
  <?php
$query=mysqli_query($conn, "SELECT * from `lacost` ORDER BY `nrx` DESC");
while($row = mysqli_fetch_assoc($query)){?>
<form action="">
<img src="<?php echo $row['rasm']; ?>" alt=""width="73%">
<h2 ><?php echo $row['name']; ?></h2>


<button><?php echo $row['nrx']; ?></button>
